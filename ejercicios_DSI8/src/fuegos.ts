...
/**
 * Clase que almacena información de pokemon de tipo fuego
 */
 export class Fuegos implements PokemonObject{
  constructor(public nombre: string, public peso_altura: string[], private tipo: string = "fuego", 
